...
namespace Tsonic.Node.ApiExtractor;
...
class Program
{
    ...
    {
        var assembly = typeof(Tsonic.Node.path).Assembly;
    ...
    static ApiDefinition ExtractApiSignatures(Assembly assembly)
    {
        ...
        // Get all public types in Tsonic.Node namespace
        var types = assembly.GetTypes()
            .Where(t => t.Namespace == "Tsonic.Node" && t.IsPublic)
            .OrderBy(t => t.Name);
